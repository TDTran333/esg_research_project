...
results_all %>% f_make_graphs("All firms - Returns only")
results_green %>% f_make_graphs("Green firms - Returns only")
results_brown %>% f_make_graphs("Brown firms - Returns only")
results_between %>% f_make_graphs("In-between firms - Returns only")
results_non_disclosed %>% f_make_graphs("Non-disclosing firms - Returns only")
...
results_all_1f %>% f_make_graphs("All firms - One-factor model")
results_green_1f %>% f_make_graphs("Green firms - O-factor model")
results_brown_1f %>% f_make_graphs("Brown firms - One-factor model")
results_between_1f %>% f_make_graphs("In-between firms - One-factor model")
results_non_disclosed_1f %>% f_make_graphs("Non-disclosing firms - One-factor model")
```
